...
print(f"Number of duplicated rows in unavailability_of_generation_units = {len(df_unav_gen[df_unav_gen.duplicated()])}")
df_unav_gen = df_unav_gen.drop_duplicates()
print(f"Number of duplicated rows in unavailability_of_generation_units excluding datetime = {len(df_unav_gen[df_unav_gen.duplicated()])}")
print(f"Number of unique rows = {len(df_unav_gen)}")
df_unav_gen.head()
